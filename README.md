...
* **Optimización**: Creación de un **Índice SQL (`idx_vessel_type`)** en el motor de la base de datos para reducir los tiempos de consulta y filtrado de milisegundos.
